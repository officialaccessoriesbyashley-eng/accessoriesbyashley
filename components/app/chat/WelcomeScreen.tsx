...
const productSuggestions = [
  ...
  "Stud earrings under KSh 2,000",
  "What bridal accessories do you have?",
];
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center text-center px-4">
      ...
      <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400 max-w-xs">
        {isSignedIn
          ? "I can help you find jewelry & accessories, check your orders, and track deliveries."
          : "I can help you find jewelry & accessories by style, material, color, or price. Sign in to check your orders too!"}
      </p>
